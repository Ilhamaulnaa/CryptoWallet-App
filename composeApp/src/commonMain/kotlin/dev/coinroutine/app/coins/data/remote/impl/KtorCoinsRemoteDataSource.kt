...
import dev.coinroutine.app.coins.data.remote.dto.CoinPriceHistoryDto
...
//) : CoinsRemoteDataSource {
//
//    override suspend fun getListOfCoin(): Result<CoinsResponseDto, DataError.Remote> {
//        return safeCall {
//            httpClient.get("$BASE_URL/coins")
//        }
//    }
...
//        return safeCall {
//            httpClient.get("$BASE_URL/coin/$coinId")
////            httpClient.post("$BASE_URL/coins"){
////                setBody(mapOf("name" to "New Coin"))
////            }
//        }
//    }
//
