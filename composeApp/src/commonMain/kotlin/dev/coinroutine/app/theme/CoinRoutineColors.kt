...
//immutable making ur UI is Smoother
@Immutable
data class CoinRoutineColorsPallete(
...
val LightCoinRoutineColorsPalette = CoinRoutineColorsPallete(
    profitGreen = ProfitGreenColor,
    lossRed = LossRedColor
)

val DarkCoinRoutineColorsPalette = CoinRoutineColorsPallete(
    profitGreen = DarkProfitGreenColor,
    lossRed = DarkLossRedColor
)

val LocalCoinRoutineColorsPalette = compositionLocalOf { CoinRoutineColorsPallete() }